    ...
    <div className='Sidebar'>
      ...
      <div className='Sidebar__user-info'>
        ...
        <div className='Sidebar__task-summary'>
          <TaskSummary countDescription='Completed Tasks' count={372} />
          <TaskSummary countDescription='Open Tasks' count={11} />
        </div>
        <div className='Sidebar__sidebar-list'>
          <SidebarList title='Menu' list={MENU_LIST} />
          <SidebarList title='Projects' list={PROJECTS_LIST} buttonText='+ Add a Project' />
          <SidebarList title='teams' list={TEAMS_LIST} buttonText='+ Add a Team' />
        </div>
      </div>
